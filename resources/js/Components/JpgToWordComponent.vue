    ...
    <div>
        <div class="flex flex-wrap gap-3 bg-blue-300 rounded-lg" v-if="!this.submitted">
            <div class="h-auto min-h-fit rounded-lg p-3 rounded-lg flex-grow">
                <div @drop.prevent="dropFile" @dragenter="dropFile" @dragover="dropFile" :class="{ ' bg-pink-800': dragActive }" style="height: 280px" class=" flex items-center justify-center w-full px-12 py-8 border-2 border-gray-300 border-dashed rounded dark:border-2">
                    ...
                    <div class="w-full flex flex-wrap flex-row justify-between gap-2  border-2 border-gray-200 rounded-md p-2  relative">
                        <div class="w-full flex flex-wrap flex-row justify-between">
                            <div class="flex flex-wrap gap-2">
                                <div>
                                    <img :src="file.dataURL" class="rounded-lg my-2 h-5 mx-auto object-contain" style="width: 40px; height: 40px">
                ...
                <div class="md:w-1/2 flex flex-wrap justify-between w-full p-3 my-1" v-for="(file,index) in files" :key="index">
                    <div class="flex flex-wrap flex-row w-full justify-between  gap-2  border-2 border-gray-200 rounded-md p-2">
                        <div class="flex flex-col flex-wrap">
                            <img :src="'images/word_image.jpg'" class="rounded-lg h-5 my-1 mx-auto object-contain" style="width: 40px; height: 40px">
...
<!--                        </div>-->
                        <div class="my-auto">
                            <a target="_blank" :href="file.dataURL" :download="file.name" class="w-full bg-blue-500 hover:bg-blue-700 p-1 mt-1 text-white rounded">Download</a>
                        </div>
                        <div class="my-auto">
        ...
        const uploadFile = async (file) => {
            ...
            reader.onload = async (event) => {
                ...
                try {
                    ...
                    console.error('Error converting image to Word:', error);
                    file.uploading = false;
                    file.error = "Error converting image to Word";
                }
            };
