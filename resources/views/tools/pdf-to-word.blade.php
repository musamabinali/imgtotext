<x-app-layout>
    ...
    <x-slot name="alternate">
        @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
            @if(trim($localeCode) == 'en')
                <link rel="alternate" hreflang="x-default" href="https://www.myconvertertool.com/pdf-to-word" />
                <link rel="alternate" hreflang="{{ $localeCode }}" href="https://www.myconvertertool.com/pdf-to-word" />
            @else
    ...
    <div class="container mx-auto pt-5 max-w-[1232px]">
        <h1 class="text-center font-semibold text-[35px]">Free PDF to Word Converter</h1>
        <div class="w-full justify-center  items-center gap-4">
            <pdf-to-word-component></pdf-to-word-component>
        </div>
